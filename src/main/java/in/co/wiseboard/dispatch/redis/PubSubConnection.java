package in.co.wiseboard.dispatch.redis;

import in.co.wiseboard.dispatch.io.RedisInputStream;
import in.co.wiseboard.dispatch.redis.protocol.ArrayReplyHeader;
import in.co.wiseboard.dispatch.redis.protocol.IntReply;
import in.co.wiseboard.dispatch.redis.protocol.StringReplyHeader;
import in.co.wiseboard.dispatch.util.Util;
...
public class PubSubConnection {
    ...
    public PubSubReply read() throws IOException{
        if(closed.get()) throw new IOException("Connnection closed!");
    ...
    private PubSubReply readMessageReply() throws IOException {
        StringReplyHeader replyHeader = new StringReplyHeader(inputStream.readLine());
        byte[]            channelName = inputStream.readFully(replyHeader.getStringLength());
        inputStream.readLine();
    ...
    private String readSubscriptionReply() throws IOException{
        ...
        IntReply _subscriptionCount = new IntReply(inputStream.readLine());
